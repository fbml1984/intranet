...
<head>
    ...
    <link href="https://cdn.datatables.net/staterestore/1.1.1/css/stateRestore.dataTables.min.css" rel="stylesheet">
...
<body>
    ...
    <div class="main h-100">
        ...
        <main role="main" class="main-content position-relative">
    ...
    <script src="{{ asset('js/smart-datatables.js') }}"></script>
