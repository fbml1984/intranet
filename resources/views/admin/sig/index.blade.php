                        ...
                        <table class="nowrap datatable table-hover order-column mb-0 table" data-scroll-x="true" data-ajax="{{ route('sig.datatables') }}">
                            <thead>
                                <tr>
                                    ...
                                    <th width="100px" data-type="link" data-icon="fa-solid fa-file-lines" data-target="_blank" data-url="{{ route('sig.documento.visualizar', '#id#') }}" data-name="id" data-sortable="false" scope="col">Visualizar</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
