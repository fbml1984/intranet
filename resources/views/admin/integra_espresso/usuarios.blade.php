            ...
            <div class="col-lg-12 py-4">
                <div class="card card-table border-0">
                    <div class="card-body">
                        ...
                        <table class="nowrap datatable table-hover order-column mb-0 table" data-scroll-x="true" data-ajax="{{ route('integra_espresso.datatables', 'usuarios') }}">
                            <thead>
                                <tr>
...
@section('scripts')
    <script type="text/javascript">
        const urlAtualizar = '{{ route('integra_espresso.atualizar_usuarios') }}'
